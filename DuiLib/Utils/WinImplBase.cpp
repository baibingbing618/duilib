...
namespace DuiLib
{
	...
	LRESULT WindowImplBase::OnNcHitTest(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled)
	{
        ...
        rcCaption.left   *= m_pm.GetDPIObj()->GetScale() / 100.0;
        rcCaption.top    *= m_pm.GetDPIObj()->GetScale() / 100.0;
        rcCaption.right  *= m_pm.GetDPIObj()->GetScale() / 100.0;
        rcCaption.bottom *= m_pm.GetDPIObj()->GetScale() / 100.0;
